...
Article.prototype.insertRecord = function(callback) {
  $.post('/articles', {author: this.author, authorUrl: this.authorUrl, body: this.body, category: this.category, publishedOn: this.publishedOn, title: this.title})
    .then(data => {
      ...
      // The purpose of this is to run a function that insertRecord is passed. It will not be invoked when the function is called because line 129 of articleView.js, there is no argument being passed, making callback false.
